import discord
import bsz_bot.helpers.document as document
import src.compare_pdf as compare_pdf
import src.table_parser as tp
import src.helpers as h
import bsz_bot.helpers.settings as settings
import copy
import camelot
import datetime
import os
from bsz_bot import BSZ_BOT
from bsz_bot.helpers.log import logger
...
if __name__ == '__main__':
    @BSZ_BOT.event
    async def on_ready():
        logger.info(f'Bot is ready! Logged in as {BSZ_BOT.user}')
